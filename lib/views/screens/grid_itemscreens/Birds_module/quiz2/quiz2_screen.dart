...
import 'package:autism_fyp/views/screens/grid_itemscreens/Birds_module/quiz2/quiz2_widget.dart';
...
class BirdHabitatscreen extends StatelessWidget {
  const BirdHabitatscreen({super.key});
          ...
          child: Column(
            ...
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  "Drag and match the birds to their habitats.",
                  style: TextStyle(
                    fontSize: 21,
              ...
              SizedBox(height: screenHeight * 0.01),
               ...
               Center(child: BirdHabitatWidget()),
            ],
          ),
        ),
      ),
