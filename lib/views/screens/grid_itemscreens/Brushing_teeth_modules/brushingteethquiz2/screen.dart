...
import 'package:autism_fyp/views/screens/grid_itemscreens/Brushing_teeth_modules/brushingteethquiz2/quiz.dart';
...
class Quiz2screen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final BrushingTeethQuiz2Controller controller = Get.put(BrushingTeethQuiz2Controller());
