...
LayoutBuilder(
  builder: (context, constraints) {
    ...
    double itemWidth = screenWidth / 2 - 20; // 3 items per row, adjust spacing
      ...
      children: controller.correctSequence.map((step) {
        return GestureDetector(
          ...
          child: Container(
            ...
            child: Column(
              children: [
                Image.asset(step["icon"]!, height: screenWidth * 0.1, width: screenWidth * 0.1),
                  ...
                  Wrap(
                    ...
                    children: controller.currentSequence.map((step) {
                      return GestureDetector(
                        ...
                        child: Chip(
                          avatar: Image.asset(step["icon"]!, height: 24, width: 24),
          ...
          // Check Answer
Obx(() {
  if (controller.currentSequence.length == controller.correctSequence.length) {
    bool isCorrect = controller.checkAnswer();
    return Column(
      children: [
        Text(
          isCorrect ? "✅ Great job! Correct Order." : "❌ Wrong! Better luck next time",
          style: TextStyle(
            fontSize: 18,
