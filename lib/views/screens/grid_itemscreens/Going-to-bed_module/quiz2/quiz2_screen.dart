...
import 'package:autism_fyp/views/screens/grid_itemscreens/Going-to-bed_module/quiz2/quiz2_widget.dart';
...
class Emotionscreeen extends StatelessWidget {
  const Emotionscreeen({super.key});
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Container(
                            ...
                            child: Obx(
                              () => Text(
                                controller.instructionText.value, // ✅ reactive text
              ...
              /// Quiz Widget
               Center(child: EmotionQuizWidget()),
            ],
          ),
        ),
      ),
