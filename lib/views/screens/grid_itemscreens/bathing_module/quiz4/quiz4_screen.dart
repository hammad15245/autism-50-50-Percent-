...
class sensoryscreen extends StatelessWidget {
  const sensoryscreen({super.key});
  
  @override
  Widget build(BuildContext context) {
    Get.lazyPut<SensoryController>(() => SensoryController());

    final SensoryController controller = Get.find<SensoryController>();
