import 'package:autism_fyp/views/screens/grid_itemscreens/bathing_module/quiz4/quiz4_widget.dart';
...
class afterbathscreen extends StatelessWidget {
  const afterbathscreen({super.key});
  
  @override
  Widget build(BuildContext context) {
    Get.lazyPut<AfterBathController>(() => AfterBathController());

    final AfterBathController controller = Get.find<AfterBathController>();
