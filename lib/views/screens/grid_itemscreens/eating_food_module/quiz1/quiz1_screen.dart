...
import 'package:autism_fyp/views/screens/grid_itemscreens/eating_food_module/quiz1/quiz1_widget.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

class FoodIdentificationscreen extends StatelessWidget {
  const FoodIdentificationscreen({super.key});

  @override
  Widget build(BuildContext context) {
    final FoodIdentificationController controller = Get.put(FoodIdentificationController());
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              /// Quiz Widget
               Center(child: FoodIdentificationQuiz()),
            ],
          ),
        ),
      ),
