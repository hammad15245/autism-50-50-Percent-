...
class BreakfastSortingscreen extends StatelessWidget {
  const BreakfastSortingscreen({super.key});

  @override
  Widget build(BuildContext context) {
    final BreakfastSortingController controller = Get.put(BreakfastSortingController());
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              /// Quiz Widget
               Center(child: BreakfastSortingWidget()),
            ],
          ),
        ),
      ),
